            ...
            <div key={i} className="flex items-center justify-start gap-5">
              <div className="grid items-center">
                <img
                  src={val.iconbox}
                  alt="icon/svg"
                  className="lg:w-15 lg:h-5"
                />
              </div>
              <div className="grid items-center">
                <h1 className="font-normal text-lg text-gray-900 filter drop-shadow-lg lg:text-base transition-all duration-150 hover:text-emerald-400">
                  {val.text}
                </h1>
              </div>
            </div>
