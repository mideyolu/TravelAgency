        ...
        <div className="travigo-container">
          ...
          <div className="grid items-center grid-cols-4 lg:grid-cols-3 md:grid-cols-2 gap-5">
            {placesAPI?.map((val, i) => (
              <div
                key={i}
                className="flex items-center gap-5 sm:gap-3 rounded-lg hover:bg-emerald-300 hover:opacity-90 transition-all duration-300 cursor-pointer hover:scale-105"
              >
                ...
                <div className="flex items-start flex-col text-slate-900">
                  ...
                  <p className="font-normal text-base sm:text-xs lg:text-sm">
                    {val.distance}
                  </p>
                </div>
              </div>
