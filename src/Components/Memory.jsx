        ...
        <div className="travigo-container flex items-center justify-between gap-16 xl:gap-9 lg:flex-col-reverse">
          <div className="flex items-center justify-start lg:justify-center w-full max-w-md">
            <img
              src={img}
              alt="memory/img"
              className=" w-auto h-[75vh] object-fill"
            />
          </div>
          <div className="grid items-center w-full max-w-2xl lg:text-center">
            ...
            <div className="grid items-center grid-cols-3 gap-7 xl:gap-3">
              {experience?.map((val, i) => (
                <div key={i} className=" bg-gradient-to-b from-emerald-500 to-green-300 shadow-lg shadow-emerald-200 flex flex-col items-center justify-center py-7 px-5 xl:p-4 rounded-lg text-slate-900 filter scale-90 drop-shadow-lg cursor-pointer hover:scale-105 transition-all duration-400 ">
